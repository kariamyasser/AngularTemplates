(self["webpackChunkkyg_angular_templates"] = self["webpackChunkkyg_angular_templates"] || []).push([["default-node_modules_ng2-dragula___ivy_ngcc___dist_fesm2015_ng2-dragula_js"],{
...
/* harmony import */ var dragula__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! dragula */ 94116);
...
var Group = /*#__PURE__*/(0,C_Users_m3nbbs_Downloads_Template_vuexylaravel_740_angular_version_full_version_full_version_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__.default)(
/**
 * @param {?} name
 * @param {?} drake
 * @param {?} options
...
function Group(name, drake, options) {
  (0,C_Users_m3nbbs_Downloads_Template_vuexylaravel_740_angular_version_full_version_full_version_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_3__.default)(this, Group);
...
var dragula = (dragula__WEBPACK_IMPORTED_MODULE_4___default()) || dragula__WEBPACK_IMPORTED_MODULE_4__;

var DrakeFactory = /*#__PURE__*/(0,C_Users_m3nbbs_Downloads_Template_vuexylaravel_740_angular_version_full_version_full_version_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__.default)(
/**
 * @param {?=} build
 */
function DrakeFactory() {
  ...
  (0,C_Users_m3nbbs_Downloads_Template_vuexylaravel_740_angular_version_full_version_full_version_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_3__.default)(this, DrakeFactory);
...
var filterEvent = function filterEvent(eventType, filterDragType, projector) {
  return function (input) {
    return input.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.filter)(function (_ref) {
      var event = _ref.event,
          name = _ref.name;
      return event === eventType && (filterDragType === undefined || name === filterDragType);
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.map)(function (_ref2) {
      var name = _ref2.name,
          args = _ref2.args;
...
var elContainerSourceProjector = function elContainerSourceProjector(name, _ref3) {
  var _ref4 = (0,C_Users_m3nbbs_Downloads_Template_vuexylaravel_740_angular_version_full_version_full_version_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__.default)(_ref3, 3),
      el = _ref4[0],
      container = _ref4[1],
      source = _ref4[2];
...
var DragulaService = /*#__PURE__*/function () {
  ...
  function DragulaService() {
    ...
    (0,C_Users_m3nbbs_Downloads_Template_vuexylaravel_740_angular_version_full_version_full_version_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_3__.default)(this, DragulaService);

    this.drakeFactory = drakeFactory;
    this.dispatch$ = new rxjs__WEBPACK_IMPORTED_MODULE_7__.Subject();

    this.drag = function (groupName) {
      return _this.dispatch$.pipe(filterEvent(EventTypes.Drag, groupName, function (name, _ref5) {
        var _ref6 = (0,C_Users_m3nbbs_Downloads_Template_vuexylaravel_740_angular_version_full_version_full_version_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__.default)(_ref5, 2),
            el = _ref6[0],
            source = _ref6[1];
    ...
    this.dragend = function (groupName) {
      return _this.dispatch$.pipe(filterEvent(EventTypes.DragEnd, groupName, function (name, _ref7) {
        var _ref8 = (0,C_Users_m3nbbs_Downloads_Template_vuexylaravel_740_angular_version_full_version_full_version_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__.default)(_ref7, 1),
            el = _ref8[0];
    ...
    this.drop = function (groupName) {
      return _this.dispatch$.pipe(filterEvent(EventTypes.Drop, groupName, function (name, _ref9) {
        var _ref10 = (0,C_Users_m3nbbs_Downloads_Template_vuexylaravel_740_angular_version_full_version_full_version_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__.default)(_ref9, 4),
            el = _ref10[0],
            target = _ref10[1],
            source = _ref10[2],
            sibling = _ref10[3];
    ...
    this.cloned = function (groupName) {
      return _this.dispatch$.pipe(filterEvent(EventTypes.Cloned, groupName, function (name, _ref11) {
        var _ref12 = (0,C_Users_m3nbbs_Downloads_Template_vuexylaravel_740_angular_version_full_version_full_version_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__.default)(_ref11, 3),
            clone = _ref12[0],
            original = _ref12[1],
            cloneType = _ref12[2];
    ...
    this.dropModel = function (groupName) {
      return _this.dispatch$.pipe(filterEvent(EventTypes.DropModel, groupName, function (name, _ref13) {
        var _ref14 = (0,C_Users_m3nbbs_Downloads_Template_vuexylaravel_740_angular_version_full_version_full_version_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__.default)(_ref13, 9),
            el = _ref14[0],
            target = _ref14[1],
            source = _ref14[2],
            sibling = _ref14[3],
    ...
    this.removeModel = function (groupName) {
      return _this.dispatch$.pipe(filterEvent(EventTypes.RemoveModel, groupName, function (name, _ref15) {
        var _ref16 = (0,C_Users_m3nbbs_Downloads_Template_vuexylaravel_740_angular_version_full_version_full_version_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__.default)(_ref15, 6),
            el = _ref16[0],
            container = _ref16[1],
            source = _ref16[2],
            item = _ref16[3],
  ...
  (0,C_Users_m3nbbs_Downloads_Template_vuexylaravel_740_angular_version_full_version_full_version_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__.default)(DragulaService, [{
    key: "add",
...
DragulaService.ɵfac = function DragulaService_Factory(t) {
  return new (t || DragulaService)(_angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵinject"](DrakeFactory, 8));
};

DragulaService.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵdefineInjectable"]({
...
(function () {
  (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵsetClassMetadata"](DragulaService, [{
...
var DragulaDirective = /*#__PURE__*/function () {
  ...
  function DragulaDirective(el, dragulaService) {
    (0,C_Users_m3nbbs_Downloads_Template_vuexylaravel_740_angular_version_full_version_full_version_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_3__.default)(this, DragulaDirective);

    this.el = el;
    this.dragulaService = dragulaService;
    this.dragulaModelChange = new _angular_core__WEBPACK_IMPORTED_MODULE_8__.EventEmitter();
  }
  /**
   * @return {?}
   */
  ...
  (0,C_Users_m3nbbs_Downloads_Template_vuexylaravel_740_angular_version_full_version_full_version_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__.default)(DragulaDirective, [{
    key: "container",
    get: function get() {
...
DragulaDirective.ɵfac = function DragulaDirective_Factory(t) {
  return new (t || DragulaDirective)(_angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_8__.ElementRef), _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵdirectiveInject"](DragulaService));
};

DragulaDirective.ɵdir = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵdefineDirective"]({
...
(function () {
  (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵsetClassMetadata"](DragulaDirective, [{
...
var DragulaModule = /*#__PURE__*/function () {
  function DragulaModule() {
    (0,C_Users_m3nbbs_Downloads_Template_vuexylaravel_740_angular_version_full_version_full_version_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_3__.default)(this, DragulaModule);
  }

  (0,C_Users_m3nbbs_Downloads_Template_vuexylaravel_740_angular_version_full_version_full_version_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__.default)(DragulaModule, null, [{
    key: "forRoot",
    value:
    /**
     * @return {?}
...
DragulaModule.ɵmod = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵdefineNgModule"]({
  type: DragulaModule
});
DragulaModule.ɵinj = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵdefineInjector"]({});

(function () {
  (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵsetClassMetadata"](DragulaModule, [{
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵsetNgModuleScope"](DragulaModule, {
    declarations: [DragulaDirective],
    exports: [DragulaDirective]
  });
})();
...
var MockDrake = /*#__PURE__*/function () {
  ...
  function MockDrake() {
    ...
    (0,C_Users_m3nbbs_Downloads_Template_vuexylaravel_740_angular_version_full_version_full_version_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_3__.default)(this, MockDrake);
    ...
    this.dragging = false;
    this.emitter$ = new rxjs__WEBPACK_IMPORTED_MODULE_7__.Subject();
    this.subs = new rxjs__WEBPACK_IMPORTED_MODULE_9__.Subscription();
  }
  /**
   * @param {?} item
  ...
  (0,C_Users_m3nbbs_Downloads_Template_vuexylaravel_740_angular_version_full_version_full_version_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__.default)(MockDrake, [{
    key: "start",
    ...
    value: function on(event, callback) {
      this.subs.add(this.emitter$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.filter)(function (_ref20) {
        var eventType = _ref20.eventType;
        return eventType === event;
      })).subscribe(function (_ref21) {
        var args = _ref21.args;
        callback.apply(void 0, (0,C_Users_m3nbbs_Downloads_Template_vuexylaravel_740_angular_version_full_version_full_version_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__.default)(args));
      }));
    }
    /**
     * @return {?}
